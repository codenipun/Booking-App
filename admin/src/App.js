      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="hotels">
              ...
              <Route
                path="new"
                element={<ProtectedRoute><NewHotel inputs={productInputs} title="Add New Hotel" /></ProtectedRoute>}
              />
          </Route>
          <Route path="rooms">
              <Route index element={
              ...
              <Route
                path="new"
                element={<ProtectedRoute><New inputs={productInputs} title="Add New Room" /></ProtectedRoute>}
              />
          </Route>
          </Route>
        </Routes>
